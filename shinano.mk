...
# IPC Security Config
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/rootdir/system/etc/sec_config:$(TARGET_COPY_OUT_VENDOR)/vendor/etc/sec_config
...
# Sensor file
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/rootdir/system/vendor/bin/init.qcom-sensor.sh:$(TARGET_COPY_OUT_VENDOR)/vendor/bin/init.qcom-sensor.sh
